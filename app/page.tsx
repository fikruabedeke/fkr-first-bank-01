import BankLogo from '@/app/ui/bank-logo';
    ...
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
         ...
         <Image src="/hero-mobile.png" width={360} height={420} className="hidden md:block" alt="Screenshots of the dashboard project showing desktop version"/>
        </div>
       </div>
    </main>
  );
